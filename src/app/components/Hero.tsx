	...
	return (
		<div className='w-full h-[750px] bg-[url(/LandingHero.jpg)] bg-cover bg-center bg-no-repeat flex flex-col'>
			<div className='w-full max-w-7xl mx-auto px-8 py-16  '>
				<div className='flex flex-col max-w-[45%] justify-center gap-8 self-stretch text-white'>
			...
			<div className='flex flex-col justify-center content-center self-stretch gap-6 px-20'>
				<h2 className='relative self-stretch text-center text-3xl not-italic font-bold after:content-[""] after:absolute after:bottom-[-12px] after:left-0 after:w-full after:h-[2px] after:bg-[#3CCED7] after:rounded-full'>
